...
<style scoped>
.subscription-page { --sub-ink:#14293a; --sub-muted:#5d7283; --sub-line:#d7e3e9; --sub-blue:#176fc1; --sub-green:#16835b; --sub-canvas:#f7fafc; --sub-sky:#eef5fa; --sub-mint:#f2f8f6; min-height:100vh; overflow:clip; color:var(--sub-ink); background:var(--sub-canvas); font-family:"Segoe UI","PingFang SC","Microsoft YaHei",sans-serif; }
...
.hero-section { position:relative; overflow:hidden; border-bottom:1px solid var(--sub-line); background:#fbfdfe; }
...
.selector-section { scroll-margin-top:128px; background:var(--sub-sky); }.selector-heading>p { max-width:520px; }
...
.process-section { background:#f9fcfd; }.process-grid { display:grid; grid-template-columns:minmax(0,.94fr) minmax(390px,.76fr); gap:82px; align-items:start; }.process-copy>p:last-of-type { max-width:650px; margin-top:18px; }.process-copy ol { margin:42px 0 0; padding:0; border-top:1px solid #b7cbd5; list-style:none; }.process-copy li { min-height:118px; display:grid; grid-template-columns:42px minmax(0,1fr); gap:17px; align-items:center; border-bottom:1px solid var(--sub-line); }.process-copy li>span { color:var(--sub-blue); font-family:"Cascadia Code",monospace; font-size:10px; font-weight:850; }.process-copy h3 { font-size:17px; }.process-copy li p { margin-top:7px; color:var(--sub-muted); font-size:13px; line-height:1.65; }
