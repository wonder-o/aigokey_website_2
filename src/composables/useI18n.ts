    ...
    heroBanners: [
      {
        ...
        copy: '¥5/天起，覆盖 Codex Agent、GPT 系列模型和 Image 系列模型。日卡适合当天急用，周卡适合一周冲刺，月卡适合长期稳定工作流；每天 $30-$200 额度，不做 API 按次调用，不做按量付费。',
        note: '适合开发、产品、运营、设计、电商、自媒体、外贸和学习办公等高频 AI 使用场景。',
    ...
    heroBanners: [
      {
        ...
        copy: 'From ¥5/day, AigoKey covers Codex Agent, GPT models, and Image models. Use a day pass for urgent work, a week pass for project sprints, or monthly tiers for stable long-term workflows.',
        note: 'Built for high-frequency AI workflows across development, product, operations, design, ecommerce, media, trade, study, and office work.',
        ...
        proof: [
          ...
          { strong: '$1.5K–$6K/mo', text: 'Generous monthly quotas for everyday productivity use.' },
        ],
      },
      {
        id: 'image',
